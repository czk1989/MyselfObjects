    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': (('can_get_index(king_admin)', '可以访问 king_admin 首页'), ('can_get_table_objs(king_admin)', '可以访问 king_admin 各个表'), ('can_post_table_objs(king_admin)', '可以修改 king_admin 每个表中对象'), ('can_get_edit_detail(king_admin)', '可以查看 king_admin 对应表详细信息'), ('can_post_edit_detail(king_admin)', '可以修改 king_admin 对应表详细信息'), ('can_get_change_pwd(king_admin)', '可以查看 king_admin 修改密码页面'), ('can_post_change_pwd(king_admin)', '可以修改 king_admin 密码'), ('can_get_obj_field_delete(king_admin)', '可以查看 king_admin 删除页面'), ('can_post_obj_field_delete(king_admin)', '可以修改 king_admin 删除页面数据'), ('can_get_obj_table_obj_add(king_admin)', '可以查看 king_admin 新增页面'), ('can_post_obj_table_obj_add(king_admin)', '可以修改 king_admin 新增页面数据')),
            },
        ),
        migrations.CreateModel(
            name='Branch',
