    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': (('can_get_acc_logout', '可以退出访问'), ('can_get_acc_login', '可以访问登录界面'), ('can_post_acc_login', '可以登录'), ('can_get_index', '可以访问 king_admin 首页'), ('can_get_table_objs', '可以访问 king_admin 各个表'), ('can_post_table_objs', '可以修改 king_admin 每个表中对象'), ('can_get_edit_detail', '可以查看 king_admin 对应表详细信息'), ('can_post_edit_detail', '可以修改 king_admin 对应表详细信息'), ('can_get_change_pwd', '可以查看 king_admin 修改密码页面'), ('can_post_change_pwd', '可以修改 king_admin 密码'), ('can_get_obj_field_delete', '可以查看 king_admin 删除页面'), ('can_post_obj_field_delete', '可以修改 king_admin 删除页面数据'), ('can_get_obj_table_obj_add', '可以查看 king_admin 新增页面'), ('can_post_obj_table_obj_add', '可以修改 king_admin 新增页面数据')),
            },
        ),
        migrations.CreateModel(
            name='Branch',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pay_type', models.CharField(blank=True, choices=[('deposit', '订金/报名费'), ('tution', '学费'), ('refund', '退款')], default='deposit', max_length=64, null=True, verbose_name='费用类型')),
                ...
                ('course', models.ForeignKey(blank=True, null=True, on_delete=None, to='crm.Course', verbose_name='所报课程')),
                ('customer', models.ForeignKey(blank=True, null=True, on_delete=None, to='crm.Customer', verbose_name='客户')),
